...
class Attendance {
    ...
    function getAttendance() {
        $sql = "SELECT  attendance_date, sum(present) as present, sum(absent) as absent FROM tbl_attendance GROUP By attendance_date";
        $result = $this->db_handle->runBaseQuery($sql);
        return $result;
    }

    function getTotalPages() {
        $total_pages_sql = "SELECT COUNT(*) FROM tbl_attendance";
